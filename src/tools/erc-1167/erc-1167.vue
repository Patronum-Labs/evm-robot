...
function extractImplementationFromBytecode(bytecode: string) {
  try {
    const minimalProxyPattern = /^0x363d3d373d3d3d363d73([0-9a-fA-F]{40})5af43d82803e903d91602b57fd5bf3/;
    ...
    if (match) {
      ...
      errorMessage.value = 'Error: This is not a minimal proxy (ERC-1167) contract';
    }
  }
  catch (error) {
    implementationAddress.value = '';
