...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/Patronum-Labs/evm-robot',
      category: 'External',
      description: 'View the source code of EVM Robot on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve EVM Robot.',
      href: 'https://github.com/Patronum-Labs/evm-robot/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about EVM Robot.',
      to: '/about',
      category: 'Pages',
